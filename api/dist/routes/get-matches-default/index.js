...
exports.getMatchesDefaultRoute = void 0;
const express_1 = require("express");
const mongo_1 = require("../../db/mongo");
const mongodb_1 = require("mongodb");
const getMatches = (0, express_1.Router)();
const getMatchesDefaultRoute = () => getMatches.get("/matches-default", async (req, res) => {
    ...
    const existingMatches = await matches
        ...
        user_id: { $ne: userId },
        sport: userProfile === null || userProfile === void 0 ? void 0 : userProfile.sport,
        category: userProfile === null || userProfile === void 0 ? void 0 : userProfile.category,
        state: userProfile === null || userProfile === void 0 ? void 0 : userProfile.state,
        city: userProfile === null || userProfile === void 0 ? void 0 : userProfile.city
    })
        .sort({ date: 1 })
        .toArray();
...
exports.getMatchesDefaultRoute = getMatchesDefaultRoute;
